...
--IF YOU ARE NOT USING CERTAIN NAME SLOTS, JUST LEAVE THEM BLANK 
	...
	CoderName1 = 'hyperlioYT Skr'
	CoderName2 = ''
	CoderName3 = ''

	ArtistName1 = 'TordXD SkR'
	ArtistName2 = ''
	ArtistName3 = ''

	MusicianName1 = 'Saster'
	MusicianName2 = ''
	MusicianName3 = ''

	CharterName1 = 'Shadow Game'
	CharterName2 = ''
	CharterName3 = '' 
...
function onCreate()
	...
	--CREDITS TEXT
	makeLuaText('CREDITS', 'Creditos de la recreacion', 1280, HorizontalWordsOffset, -1000)
	...
	--CHARTING TEXT
	makeLuaText('CHARTERS', 'FAN CHART', 1280, HorizontalWordsOffset, -1000)
